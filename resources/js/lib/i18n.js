...
const EN = {
  ...
  'কখন শুরু হবে?': 'When does it start?',
  'সাপ্তাহিক ছুটি কেমন?': 'How is the weekly holiday?',
  'বুঝতে পারিনি': 'I did not catch that',
  'আরেকবার বলুন': 'Say it again',
  'ধন্যবাদ': 'Thank you',
  'এটার দাম কত?': 'How much is this?',
  'অন্য সাইজ আছে?': 'Do you have another size?',
  'চেঞ্জ রুম কোথায়?': 'Where is the changing room?',
  'কার্ডে পে করা যাবে?': 'Can I pay by card?',
  'ডিসকাউন্ট আছে?': 'Is there a discount?',
  'মাথা ব্যথা করছে': 'I have a headache',
  'কতবার খাবো?': 'How often should I take it?',
  'কাল থেকে অসুস্থ': 'Sick since yesterday',
  'খাবারের আগে না পরে?': 'Before or after meals?',
  'বুকের এক্স-রে': 'Chest X-ray',
  'পরামর্শের জন্য ধন্যবাদ': 'Thank you for the advice',
  'গেট ৫ কোথায়?': 'Where is gate 5?',
  'আমার পাসপোর্ট': 'My passport',
  'ফ্লাইট ঠিক সময়ে আছে?': 'Is the flight on time?',
  'বোর্ডিং কখন শুরু?': 'When does boarding start?',
  'ওয়াশরুম কোথায়?': 'Where is the washroom?',
  'আমি ভালো আছি': 'I am fine',
  'সপ্তাহের ছুটিতে কি করলেন?': 'What did you do on the weekend?',
  'চা খাওয়ার দাওয়াত': 'Invitation for tea',
  'নতুন মুভি দেখেছেন?': 'Have you seen any new movies?',
  'আজকের আবহাওয়া': 'Today\'s weather',
  'পরে কথা হবে': 'Speak later',
  'ইংরেজি শেখা': 'Learning English',
  'আমার ভুল শুধরে দিন': 'Correct my mistakes',
  'একটি উদাহরণ দিন': 'Give an example',
  'ধীরে বলুন': 'Speak slowly',
  'দিনটি কেমন গেলো?': 'How was your day?',
  'সহজ করে বলুন': 'Explain simply',
  'পরবর্তী মাইলফলক': 'Next Milestone',
  'A1 প্রফিসিয়েন্সি সার্টিফিকেট': 'A1 Proficiency Certificate',
  'A2 প্রফিসিয়েন্সি সার্টিফিকেট': 'A2 Proficiency Certificate',
  'B1 প্রফিসিয়েন্সি সার্টিফিকেট': 'B1 Proficiency Certificate',
  ...
  'সর্বনিম্ন গ্রহণযোগ্য ঘণ্টা-হার': 'Minimum Acceptable Hourly Rate',
  'প্রধান মুদ্রা': 'Primary Currency',
  'ভাষা ও দেখা': 'Language & Display',
  'ভাষা': 'Language',
  'টেক্সট সাইজ': 'Text Size',
  'মনে করিয়ে দেওয়া': 'Reminders',
  'সময়সীমার আগে': 'Before Deadline',
  'বকেয়া টাকার তাগাদা': 'Overdue Payment Reminder',
  'কাগজের মেয়াদ': 'Document Expiry',
  'সব তথ্য ফাইল হিসেবে নিন': 'Download All Data as File',
  'সম্পর্কে': 'About',
  'ভার্সন': 'Version',
  'শর্তাবলী': 'Terms & Conditions',
  'মতামত দিন': 'Give Feedback',
  'সব তথ্য আপনার ডিভাইসেই থাকে': 'All data stays on your device',
  'প্রোফাইল সম্পাদনা': 'Edit Profile',
  'ছবি পরিবর্তন করুন': 'Change Photo',
  'পুরো নাম': 'Full Name',
  'আপনার নাম লিখুন': 'Enter Your Name',
  'জন্ম তারিখ': 'Date of Birth',
  'কাজের নিয়ম সংশোধন': 'Edit Work Rules',
  'সাপ্তাহিক টার্গেট ঘণ্টা': 'Weekly Target Hours',
  'রিমাইন্ডার টাইমিং সংশোধন': 'Edit Reminder Timing',
  'সময়সীমার কত দিন পূর্বে নোটিফিকেশন পাঠাবে': 'How many days before deadline to notify',
  'বকেয়া টাকার তাগাদা কত দিন পর পাঠাবে': 'How many days after to send overdue payment reminder',
  'কাগজের মেয়াদের কত দিন পূর্বে নোটিফিকেশন পাঠাবে': 'How many days before document expiry to notify',
  ...
  'আবার দিন': 'Retake',
  'তথ্য': 'Info',
  'একটি ইংরেজি বাক্য লিখুন': 'Write an English sentence',
  'আমরা সেটিকে সাধারণ ভুলের তালিকার সাথে মিলিয়ে দেখি': 'We match it against a list of common mistakes',
  'নির্দিষ্ট তালিকা মিলিয়ে ভুল ও সঠিক রূপ দেখায়': 'Shows the mistake and its correct form from a fixed list',
  'সম্পূর্ণ অফলাইন': 'Fully offline',
  'কোনো ইন্টারনেট লাগে না — সব যাচাই ডিভাইসেই হয়': 'No internet needed — all checks happen on your device',
  'তালিকায় নেই?': 'Not in the list?',
  'AI সঙ্গীকে জিজ্ঞাসা করুন — ইন্টারনেট লাগবে': 'Ask the AI companion — internet required',
  ...
  'সংরক্ষিত': 'Saved',
  'কোনো সংরক্ষিত বাক্য নেই': 'No saved phrases yet',
  'বাক্যের পাশের স্টার চেপে সংরক্ষণ করুন': 'Tap the star on any phrase to save it',
  ...
  'মাইক্রোফোনে কথা বলুন — AI উত্তর দেবে কণ্ঠে': 'Talk on the mic — the AI replies by voice',
  'মাইক্রোফোনে ট্যাপ করে কথা শুরু করুন': 'Tap the mic to start speaking',
  'শুনছি…': 'Listening…',
  'ভাবছি…': 'Thinking…',
  'বলছি…': 'Speaking…',
  'কোনো পরিস্থিতি নেই': 'No scenario available',
  'শোনা বন্ধ করুন': 'Stop listening',
  'কথা শুরু করুন': 'Start talking',
  'স্বয়ংক্রিয়': 'Auto',
  'স্বয়ংক্রিয় চালু': 'Auto-continue',
  'মাইক্রোফোন ব্যবহারের অনুমতি দিন': 'Allow microphone access to talk',
  'ইন্টারনেট সংযোগ পরীক্ষা করুন': 'Check your internet connection',
  'এই ব্রাউজারে ভয়েস শোনা যায় না': 'Voice input is not supported in this browser',
  ...
  'প্রথম পাঠ — মাত্র {n} মিনিটে। ফোন নম্বর দিয়েই শুরু, কোনো ঝামেলা নেই।': 'Your first lesson — just {n} minutes. Start with your phone number, no hassle.',
  'প্রশ্নোত্তর': 'FAQ',
  ...
  // ── easy rise: Onboarding ────────────────────────────────────────
  'প্রথম কাজ থেকে নিজের ব্যবসা পর্যন্ত': 'From your first job to your own business',
  'শেখা, কাজ গোছানো, আর টাকা দেশে আনা — সব এক জায়গায়': 'Learn, organize work, and bring money home — all in one place',
  'আগে থেকেই কাজ করছি': 'Already working',
  'আপনার ফোন নম্বর': 'Your phone number',
  'একটি ছয় অঙ্কের কোড পাঠানো হবে': 'A six-digit code will be sent',
  'কোড পাঠান': 'Send code',
  'কোড লিখুন': 'Enter code',
  'কোডটি মিলছে না': 'Code does not match',
  'শুরুর তথ্য': 'Starting info',
  'আপনি এখন কোথায়?': 'Where are you now?',
  'এখনো শুরু করিনি': 'Haven\'t started yet',
  'প্রথম কাজের চেষ্টা করছি': 'Trying for first job',
  'নিয়মিত কাজ পাচ্ছি': 'Getting regular work',
  'নিজের দল আছে': 'Have my own team',
  'সপ্তাহে কত ঘণ্টা কাজ করতে পারবেন?': 'How many hours per week can you work?',
  'সর্বনিম্ন গ্রহণযোগ্য ঘণ্টা-হার': 'Minimum acceptable hourly rate',
  'এর নিচে নামলে অ্যাপ চিহ্ন দেখাবে': 'The app will flag if you go below this',
  'প্রধান মুদ্রা': 'Primary currency',
  'সংরক্ষণ করে এগোন': 'Save and continue',
  'সব তথ্য আপনার ডিভাইসেই থাকে, পরে বদলানো যাবে': 'All data stays on your device, changeable later',
  'পরে করব': 'Do later',

  // ── easy rise: Today hub (Screen 04) ─────────────────────────────
  'চলতি কাজ': 'Active jobs',
  'বকেয়া': 'Overdue',
  'সম্মত': 'Agreed',
  'এই সপ্তাহের চাপ': 'This week\'s load',
  'ঘণ্টা': 'hours',
  'আর {n} ঘণ্টা নেওয়া যাবে': '{n} more hours available',
  'ক্ষমতার বেশি নেওয়া হয়েছে': 'Over capacity',
  'আজকের কাজ': 'Today\'s jobs',
  'রাইজ ল্যাডার': 'Rise Ladder',
  'দেখুন': 'View',

  // ── easy rise: Learn hub (Screen 06) ─────────────────────────────
  'শেখার অগ্রগতি': 'Learning progress',
  'ভিত্তি': 'Foundations',
  'শেষ': 'Done',
  'আপনার নিজের জন্য': 'For you personally',
  'মার্কেটপ্লেস তুলনা': 'Marketplace Comparison',
  'কোন প্ল্যাটফর্মে বিরোধ হলে কে সিদ্ধান্ত নেয়': 'Which platform decides disputes',
  'নিশ ফিট স্কোরার': 'Niche Fit Scorer',
  'নিজের গোনা সংখ্যা দিয়ে যাচাই': 'Verify with your own counted numbers',
  'প্রোফাইল ও পোর্টফোলিও চেকলিস্ট': 'Profile & Portfolio Checklist',
  'ক্লায়েন্ট আসলে যা দেখেন': 'What clients actually check',
  'প্রস্তাব কাঠামো লাইব্রেরি': 'Proposal Structure Library',
  'যে প্রস্তাব পড়া হয় তার গঠন': 'Structure of proposals that get read',
  'ক্লায়েন্ট কথোপকথন স্ক্রিপ্ট': 'Client Conversation Scripts',
  'কঠিন কথাগুলো কীভাবে লিখবেন': 'How to write the hard conversations',
  'আমার ৯০ দিনের পরিকল্পনা': 'My 90-Day Plan',
  'তৈরি হয়েছে': 'Created',
  'এখনো তৈরি হয়নি': 'Not created yet',
  'প্রোফাইল রিভিউ': 'Profile Review',
  'তৈরি করুন': 'Create',

  // ── easy rise: Work tab ──────────────────────────────────────────
  'পাইপলাইন': 'Pipeline',
  'প্রস্তাব পাঠানো': 'Proposals sent',
  'চলছে': 'In progress',
  'জমা দেওয়া': 'Delivered',
  'কাজের বিস্তারিত': 'Job Detail',
  'সম্মত ডেলিভারি': 'Agreed delivery',
  'কনসেপ্ট': 'concepts',
  'রিভিশন': 'revisions',
  'বিবরণ': 'Details',
  'স্কোপ': 'Scope',
  'অবস্থা বদলান': 'Change status',
  'বাড়তি অনুরোধ যোগ করুন': 'Add extra request',
  'স্কোপ ও রিভিশন গার্ড': 'Scope & Revision Guard',
  'যা সম্মত হয়েছিল': 'What was agreed',
  'যা বাড়তি চাওয়া হয়েছে': 'What was extra',
  'প্রস্তাব ট্র্যাকার': 'Proposal Tracker',
  'উত্তরের হার': 'Reply rate',
  'কাজ পাওয়ার হার': 'Win rate',
  'বকেয়া ও তাগাদা ধাপ': 'Payments Due & Escalation',
  'মনে করিয়ে দেওয়া': 'Reminder',
  'স্পষ্ট দাবি': 'Clear claim',
  'কাজ থামানোর নোটিশ': 'Work stop notice',
  'প্ল্যাটফর্মের বিরোধ প্রক্রিয়া': 'Platform dispute process',
  'কাজের চাপ মিটার': 'Capacity Meter',
  'ক্ষমতার': 'of capacity',
  'কোন কাজ কত চাইছে': 'How much each job demands',
  'চাপ কমাতে': 'To reduce load',
  'ক্লায়েন্ট ঝুঁকি স্ক্রিনার': 'Client Red-Flag Screener',
  'এগোনোর আগে কয়েকটি বিষয় পরিষ্কার করে নিন': 'Clarify a few things before proceeding',
  'কোনো সতর্কচিহ্ন পাওয়া যায়নি': 'No warning signs found',
  'প্রশ্ন করে নিন': 'Ask about these',
  'এগোনোর আগে থামুন': 'Stop before proceeding',

  // ── easy rise: Money tab ─────────────────────────────────────────
  'গত ১২ মাসে দেশে এসেছে': 'Received in last 12 months',
  'নিরাপদ মাসিক খরচ': 'Safe monthly expense',
  'রানওয়ে': 'Runway',
  'হিসাব': 'Tools',
  'আয়ের খাতা': 'Income Ledger',
  'প্রতিটি প্রাপ্তি লিখে রাখুন': 'Record each payment',
  'রেট ও প্রকৃত ঘণ্টা-আয়': 'Rate & True Hourly',
  'ঘণ্টায় আসলে কত এলো': 'What an hour really earned',
  'স্থিতিশীলতা ও রানওয়ে': 'Stability & Runway',
  'কত মাস চলবে': 'How many months it lasts',
  'আয়ের প্রমাণপত্র': 'Income Proof',
  'ব্যাংক বা দূতাবাসের জন্য': 'For bank or embassy',
  'দেশে আনা ও কাগজ': 'Bringing home & paperwork',
  'টাকা দেশে আনার চ্যানেল': 'Channels to bring money home',
  'প্রণোদনা হিসাব ও যোগ্যতা': 'Remittance Incentive',
  'কাগজপত্র প্রস্তুতি': 'Document Readiness',
  'বাকি': 'remaining',
  'মোট': 'Total',
  'প্রাপ্তি': 'receipts',
  'গত ১২ মাস': 'Last 12 months',
  'সব চ্যানেল': 'All channels',
  'মোট {n}': 'Total {n}',
  'সর্বশেষ যাচাই': 'Last verified',

  // ── easy rise: Assistant (Screen 14) ─────────────────────────────
  'খসড়া তৈরি করুন': 'Generate draft',
  'সংক্ষিপ্ত': 'Brief',
  'কোন কাজের জন্য?': 'For which job?',
  'কোনোটি নয়': 'None',
  'কাজের বিবরণ আর আপনি যা বলতে চান — বাংলায় লিখলেও চলবে': 'Job description and what you want to say — Bangla is fine',
  'কোন অংশ কী করছে': 'What each part does',
  'সম্পাদনা': 'Edit',
  ...
  'বাংলা': 'Bangla',
  'সময়সীমার আগে': 'Before deadline',
  'বকেয়া টাকার তাগাদা': 'Overdue payment nudge',
  'কাগজের মেয়াদ': 'Document expiry',
  'সব তথ্য ফাইল হিসেবে নিন': 'Export all data as file',
