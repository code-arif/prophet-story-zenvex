...
export default function ReaderStandard({ chapter, prophet, navigation, resumeScroll, isRead: propIsRead, reflectionQuestions = [], familyStreak = { streak: 0, today_logged: false } }) {
