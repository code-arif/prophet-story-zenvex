          ...
          <div className="lg:col-span-5 space-y-5 lg:sticky lg:top-24">
            <div className="p-5 rounded-2xl border border-purple-200 shadow-sm space-y-4 bg-gradient-to-br from-purple-700 via-purple-800 to-indigo-900 text-white">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl bg-white text-purple-800 font-extrabold text-[14px] hover:bg-purple-50 transition-all flex items-center justify-center gap-2 shadow-md active:scale-95 cursor-pointer"
              >
                <Zap className="size-4 text-purple-800 fill-current" />
