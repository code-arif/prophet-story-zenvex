  ...
  return (
    <div className="space-y-6 font-bn max-w-5xl mx-auto pb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        {/* Left Column: Filter Row & Checklist Items (8 cols on desktop) */}
        <div className="lg:col-span-8 space-y-5">
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none">
            ...
            >
              বাকি আছে ({toBnDigits(totalCount - doneCount)})
            </button>
            <button
              type="button"
        ...
        {/* Right Column: Progress Gauge Card & AI Review CTA (4 cols on desktop) */}
        <div className="lg:col-span-4 space-y-5 lg:sticky lg:top-24">
          ...
          <div className="glass p-5 rounded-2xl border border-slate-100 shadow-sm space-y-3">
            <div className="flex justify-between items-end">
              ...
              <span className="text-[12px] font-extrabold text-brand bg-brand/10 px-2.5 py-1 rounded-full border border-brand/20">
                {toBnDigits(progressPct)}% সম্পন্ন
              </span>
            </div>
            ...
            <p className="text-[12.5px] text-slate-500 font-medium pt-1 leading-relaxed">
              ক্লায়েন্ট নিয়োগের সিদ্ধান্ত নেওয়ার আগে এই গুরুত্বপূর্ণ চেকলিস্টগুলোই বেশি গুরুত্ব দেন।
            </p>
          </div>

          {/* AI Review CTA */}
          <div className="glass p-5 rounded-2xl border border-violet-100 shadow-sm relative overflow-hidden space-y-4 bg-gradient-to-br from-violet-50/50 via-white to-purple-50/40">
